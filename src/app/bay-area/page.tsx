...
export const metadata: Metadata = {
  title: "Exotic Car Rental Bay Area | Lamborghini, G-Wagon, BMW | World Class Exotic",
  description:
    "Rent exotic cars in the Bay Area. Lamborghini, G-Wagon, BMW M3 & more delivered to San Francisco, Oakland, San Jose, Silicon Valley. Book now.",
  robots: {
    index: false,
    follow: false,
  },
...
const testimonials = [
  {
    text: "Rented the Lamborghini for a client dinner in SF. They delivered to my hotel in the Financial District. 10/10.",
    name: "David L.",
  },
  {
    text: "BMW M3 for a weekend drive through the hills. Seamless process, great car, will book again.",
    name: "Sarah C.",
  },
];

export default function BayAreaAdPage() {
  const cars = getCarsByLocation("bay-area");
        ...
        <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <h1 className="font-[family-name:var(--font-heading)] text-5xl sm:text-7xl md:text-8xl tracking-wider leading-none mb-6">
              ...
              <span className="text-gradient-gold">IN THE BAY AREA</span>
            </h1>
            <p className="text-white/70 text-base sm:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
              Lamborghini, G-Wagon, BMW M3 &amp; more. Delivered anywhere in San Francisco, Oakland, San Jose, and Silicon Valley.
            </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-14">
              ...
              <p className="text-text-muted max-w-xl mx-auto">
                Every vehicle is detailed, inspected, and delivered to you. Same-day bookings available across the Bay.
              </p>
            </div>
        ...
        <section className="section-dark py-12 sm:py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-10">
              ...
              <p className="text-text-muted max-w-xl mx-auto">
                We deliver across the entire Bay Area. SF, East Bay, Peninsula, South Bay — just tell us where.
              </p>
            </div>
        ...
        <section className="section-dark py-16 sm:py-24">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <h2 className="font-[family-name:var(--font-heading)] text-4xl sm:text-6xl tracking-wider mb-4">
              READY TO RIDE <span className="text-gradient-gold">THE BAY?</span>
            </h2>
            <p className="text-text-muted mb-10 text-lg">
              Same-day delivery available across the Bay Area. Reserve your exotic now.
            </p>
            <Link href="/booking" className="btn-gold text-lg px-10 py-4">
              Book Your Bay Area Rental
            </Link>
